    ...
    if (strict) {
        ...
        if (val1 === null || typeof val1 !== 'object') {
            if (val2 === null || typeof val2 !== 'object') {
                return (
                    val1 == val2 || (Number.isNaN(val1) && Number.isNaN(val2))
                );
            }
            return false;
        }
    ...
    if (isStringObject(a)) {
        return (
            ...
            String.prototype.valueOf.call(a) ===
                String.prototype.valueOf.call(b)
        );
    }
    ...
    if (isBigIntObject(a)) {
        return (
            ...
            BigInt.prototype.valueOf.call(a) ===
                BigInt.prototype.valueOf.call(b)
        );
    }
    if (isSymbolObject(a)) {
        return (
    ...
    for (const { 0: key, 1: item1 } of map1) {
        if (typeof key === 'object' && key !== null) {
            ...
            if (
                ...
                if (strict) return false;
                if (
                    !mapMightHaveLoosePrimitive(map1, map2, key, item1, memos)
                ) {
                    return false;
                }
                if (set === null) {
