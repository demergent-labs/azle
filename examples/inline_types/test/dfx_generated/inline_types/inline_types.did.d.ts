...
export type TestVariant = { prop1: string } | { prop2: Test1 };
...
export interface _SERVICE {
    ...
    inlineRecordReturnType: () => Promise<{ prop1: string; prop2: string }>;
    inlineVariantParam: (
        arg_0: { var1: null } | { var2: null }
    ...
    recordReferencingRecordFromParam: (arg_0: {
        test: Test;
    }) => Promise<string>;
    recordReferencingVariantFromParam: (arg_0: {
        testVariant: TestVariant;
    }) => Promise<[] | [string]>;
    recordWithInlineFields: () => Promise<User1>;
    variantReferencingOtherTypesFromReturnType: () => Promise<
        { prop1: string } | { prop2: Bling }
    >;
    variantReferencingRecordFromParam: (arg_0: {
        prop1: User;
    }) => Promise<undefined>;
    variantReferencingVariantFromParam: (arg_0: {
        prop1: UserVariant;
    }) => Promise<undefined>;
