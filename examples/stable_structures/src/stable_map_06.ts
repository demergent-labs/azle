...
export function stable_map_6_items(): Update<[nat64[], boolean][]> {
    return stable_map_6.items();
}

export function stable_map_6_keys(): Update<nat64[][]> {
...
export function stable_map_6_values(): Update<boolean[]> {
