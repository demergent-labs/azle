import { nat, nat64, Opt, $query, StableBTreeMap, $update, Vec } from 'azle';
import { InsertResult, User } from '../types';
...
$update;
export function stableMap11Insert(key: nat, value: User): InsertResult<User> {
