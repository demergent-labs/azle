...
export function stable_map_10_items(): Update<[float32, Opt<boolean>][]> {
    return stable_map_10.items();
}

export function stable_map_10_keys(): Update<float32[]> {
...
export function stable_map_10_values(): Update<Opt<boolean>[]> {
