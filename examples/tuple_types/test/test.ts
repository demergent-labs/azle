...
const tuple_types_canister = createActor(
...
const tests: Test[] = [
    ...
    // },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.primitive_two_tuple_return_type();
    ...
    },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.primitive_two_tuple_param(['Folly', 6433n]);
    ...
    },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.primitive_three_tuple_return_type();
    ...
    },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.primitive_three_tuple_param(['Antarctica', 41415n, Principal.fromText('aaaaa-aa')]);
    ...
    },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.complex_two_tuple_return_type();
    ...
    },
    {
        ...
        test: async () => {
            const result = await tuple_types_canister.complex_three_tuple_return_type();
            ...
            return {
                ok: (
                    ...
                    result[2].Bad[1].id === '1' &&
                    result[2].Bad[1].primitive_two_tuple[0] === 'Content-Type' &&
