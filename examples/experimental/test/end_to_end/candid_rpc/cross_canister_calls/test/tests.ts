    ...
    return () => {
        ...
        it('propagates traps across cross canister calls', async () => {
            ...
            const partialErrorMessage = new RegExp(
                `Error from Canister ${canister1Id}: Canister called \`ic0.trap\` with message: 'Uncaught Error: The inter-canister call failed with reject code 5: IC0503: Error from Canister ${canister2Id}: Canister called \`ic0.trap\` with message: 'hahahaha'`
            );
