...
function pretest(): void {
    execSync(
        `cp ../../../../../../.openvaluesharing.json node_modules/unpipe`,
        {
            stdio: 'inherit'
        }
    );
    ...
    execSync(
        `cp ../../../../../../.openvaluesharing.json node_modules/has-symbols`,
        {
            stdio: 'inherit'
        }
    );
    ...
    execSync(
        `cp ../../../../../../.openvaluesharing.json node_modules/safe-buffer`,
        {
            stdio: 'inherit'
        }
    );
    ...
    execSync(
        `cp ../../../../../../.openvaluesharing.json node_modules/hasown`,
        {
            stdio: 'inherit'
        }
    );
