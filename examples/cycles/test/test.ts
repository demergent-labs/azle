...
const canisterName = 'cycles';

const cyclesCanister = createCyclesActor(getCanisterId(canisterName), {
    agentOptions: {
...
runTests(canisterName, getTests(cyclesCanister, intermediaryCanister));
