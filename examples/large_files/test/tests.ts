 ...
 *
 * destPath must be a fully defined path to the file. If srcPath is a file
 * then it will use that path exactly, if srcPath is a dir then it will use the
 * file name of the destPath.
 *
 * @param origin
 * @param canisterPath
 * @param localDir
