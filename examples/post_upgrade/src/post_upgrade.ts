import {
    ...
    float32,
    Principal
    // TODO also do records and variants
} from 'azle';

// TODO I am not sure how to test the upgrade process entirely, it's complicated because you have to change the code to test...perhaps I'll just do simple tests for now

// TODO the biggest problem here is updating the Stable type itself...we need to not ask for the new fields added in the first post_upgrade after an upgrade
// TODO only after...I am not exactly sure how we'll store that state though
// TODO I suppose in the pre upgrade we can store information about what should come out of the post_upgrade??

// TODO upgrading the stable storage type seems to cause some major issues...
// TODO I think you can only set the stable variables one time for now
// TODO I think we need to make sure that candid rust structs are created for types referenced from here...
// TODO abosuletly actually, should be pretty similar to the cross canister calls way of doing it
...
// export function test(): Query<void> {}
...
//     ic.print('pre upgrade!!!');
//     ic.stableStorage<StableStorage>().stableInt = 0n;
// }
