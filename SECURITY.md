...
We will only update Azle in response to security vulnerabilities found in its latest stable <a href="https://github.com/demergent-labs/azle/releases" target="_blank">GitHub release</a> and corresponding published [npm version](https://www.npmjs.com/package/azle?activeTab=versions).
