...
pub fn int_init_stack(num_inits: u32) -> u64 {
    let performance_start = ic_cdk::api::call::performance_counter(0);

    let mut i = 0;

    while i < num_inits {
        let value = if i % 2 == 0 { ic_cdk::export::candid::Int(170_141_183_460_469_231_731_687_303_715_884_105_727i128.into()) } else { ic_cdk::export::candid::Int(0i128.into()) };
...
#[ic_cdk_macros::update]
pub fn int_init_heap(num_inits: u32) -> u64 {
    let performance_start = ic_cdk::api::call::performance_counter(0);
