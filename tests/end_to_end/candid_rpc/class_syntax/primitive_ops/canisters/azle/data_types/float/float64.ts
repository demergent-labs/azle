import { float64, ic, nat32, update } from 'azle/experimental';

import { PerfResult } from '../../perf_result';

let heap_storage: { [key: string]: float64 | undefined } = {};

export const float64_init_stack = update([nat32], PerfResult, (num_inits) => {
...
export const float64_init_heap = update([nat32], PerfResult, (num_inits) => {
    const perf_start = ic.performanceCounter(0);
