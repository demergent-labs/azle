import { float32, ic, nat32, update } from 'azle/experimental';

import { PerfResult } from '../../perf_result';

let float32_init_heap_storage: { [key: string]: float32 | undefined } = {};

export const float32_init_stack = update([nat32], PerfResult, (num_inits) => {
...
export const float32_init_heap = update([nat32], PerfResult, (num_inits) => {
    const perf_start = ic.performanceCounter(0);
