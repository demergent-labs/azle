...
use crate::ts_ast::program::AzleProgram;
use proc_macro2::TokenStream;
use quote::{format_ident, quote};

pub mod functions;

pub trait IcObjectHelperMethods {
    fn generate_ic_object(&self) -> TokenStream;
    fn generate_notify_functions(&self) -> Vec<TokenStream>;
}

impl IcObjectHelperMethods for Vec<AzleProgram> {
    fn generate_ic_object(&self) -> proc_macro2::TokenStream {
