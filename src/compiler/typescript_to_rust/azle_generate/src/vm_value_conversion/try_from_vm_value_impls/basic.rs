pub fn generate() -> proc_macro2::TokenStream {
    quote::quote! {
        ...
        impl CdkActTryFromVmValue<(), &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<(), CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<bool, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<bool, CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<String, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<String, CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<ic_cdk::export::candid::Empty, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<ic_cdk::export::candid::Empty, CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<ic_cdk::export::candid::Reserved, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<ic_cdk::export::candid::Reserved, CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<ic_cdk::export::candid::Func, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<ic_cdk::export::candid::Func, CdkActTryFromVmValueError> {
        ...
        impl CdkActTryFromVmValue<ic_cdk::export::Principal, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<ic_cdk::export::Principal, CdkActTryFromVmValueError> {
                match self.as_object() {
        ...
        impl CdkActTryFromVmValue<ic_cdk_timers::TimerId, &mut boa_engine::Context> for boa_engine::JsValue {
            fn try_from_vm_value(self, context: &mut boa_engine::Context) -> std::result::Result<ic_cdk_timers::TimerId, CdkActTryFromVmValueError> {
