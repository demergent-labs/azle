...
pub fn generate() -> TokenStream {
    ...
    quote! {
        fn js_object_to_string(
            ...
            try_js_object_to_string(js_value, js_object, nesting_level, context).unwrap_or_else(
                |js_error| {
        ...
        fn try_js_object_to_string(
            ...
            if js_object.is_array() {
                return Ok(js_array_object_to_string(js_object, nesting_level, context));
            }

            if js_object.is_error() {
                return Ok(js_error_object_to_string(js_object, nesting_level, context));
            }
