...
import { generateAll } from './type_alias_parsing/generate_alias_table';
...
export function compileTypeScriptToRust(
    ...
    time('[1/2] 🔨 Compiling TypeScript...', 'inline', () => {
        ...
        const aliasTables = generateAll(fileNames, program, 'TABLE');
        const aliasLists = generateAll(fileNames, program, 'LIST');
