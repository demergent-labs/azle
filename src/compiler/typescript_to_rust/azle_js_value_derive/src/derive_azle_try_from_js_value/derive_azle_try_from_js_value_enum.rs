...
pub fn derive_azle_try_from_js_value_enum(
    ...
    quote! {
        ...
        // impl AzleTryFromJsValue<Vec<Box<#enum_name>>> for boa_engine::JsValue {
        //     fn azle_try_from_js_value(self, context: &mut boa_engine::Context) -> Result<Vec<Box<#enum_name>>, AzleTryFromJsValueError> {
        //         match self.as_object() {
        //             Some(js_object) => {
        //                 if js_object.is_array() {
        //                     let mut processing: bool = true;
