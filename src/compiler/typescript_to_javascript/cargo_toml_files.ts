...
export function generateLibCargoToml(canisterName: string): Toml {
    return `
        ...
        # boa_engine = { git = "https://github.com/demergent-labs/boa", rev = "8cd3b185eef881deac0c8a6500eef89b7e308863" }
        boa_engine = { path = "/home/lastmjs/development/boa/boa_engine" }
...
export function generateWorkspaceCargoLock(): Toml {
    return `
        ...
        name = "boa_ast"
        version = "0.16.0"
        source = "git+https://github.com/demergent-labs/boa?rev=9ef62f77d8f0ce01053452c55b5a51e2a912e60d#9ef62f77d8f0ce01053452c55b5a51e2a912e60d"
        dependencies = [
        "bitflags",
        "boa_interner",
        "boa_macros",
        ...
        name = "cdk_framework"
        version = "0.0.0"
        source = "git+https://github.com/demergent-labs/cdk_framework?rev=4eb94999c137dc35142898206ab12415832f2381#4eb94999c137dc35142898206ab12415832f2381"
        dependencies = [
        "proc-macro2",
        "quote",
        "regex",
